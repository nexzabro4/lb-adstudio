...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url(${bg})` }}>
      <div className="md:w-2/3 lg:w-1/2 xl:w-1/3 bg-red-500 p-8 rounded-lg">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <button
              ...
              className={`bg-white text-red-500 px-6 py-2 rounded-full ${(!formData.Mobile || !formData.Name) ? 'opacity-50 cursor-not-allowed' : 'hover:bg-red-700 hover:text-white transition duration-300'
                }`}
            >
              Submit
            </button>
